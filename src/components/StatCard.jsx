export default function StatCard({ icon: Icon, label, value, subtitle, color = 'primary', onClick }) {
  ...
  return (
    <div
      onClick={onClick}
      className={`bg-white dark:bg-[#141414] rounded-2xl border border-gray-200 dark:border-[#262626] shadow-card p-4 ${onClick ? 'cursor-pointer hover:shadow-card-hover active:scale-[0.98] transition-all' : ''}`}
    >
