          ...
          {step === 'otp' ? (
            ...
            <>
              ...
              <div className="flex items-center gap-3 my-5">
                ...
                <span className="text-xs text-slate-400 dark:text-slate-500 font-medium">veya</span>
                <div className="flex-1 h-px bg-slate-200 dark:bg-white/10" />
              </div>
              ...
              <button
                ...
                disabled={loading}
                onClick={() => {
                  // Native Apple Sign In (Capacitor plugin) veya web fallback
                  alert('Apple ile giriş şu anda sadece iOS uygulamasında desteklenmektedir.')
                }}
                className="w-full flex items-center justify-center gap-3 py-3.5 bg-black dark:bg-white text-white dark:text-black rounded-2xl font-semibold text-sm active:scale-[0.98] transition-all duration-200 mb-3"
              >
              ...
              <button
                ...
                disabled={loading}
                onClick={() => {
                  // Native Google Sign In (Capacitor plugin) veya web fallback
                  alert('Google ile giriş şu anda sadece mobil uygulamada desteklenmektedir.')
                }}
                className="w-full flex items-center justify-center gap-3 py-3.5 bg-white dark:bg-white/[0.06] border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 rounded-2xl font-semibold text-sm hover:bg-slate-50 dark:hover:bg-white/[0.1] active:scale-[0.98] transition-all duration-200"
              >
